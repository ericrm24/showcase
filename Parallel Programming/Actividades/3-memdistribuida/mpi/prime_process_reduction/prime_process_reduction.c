...
int main(int argc, char* argv[])
{
	...
	start_time = MPI_Wtime();
		...
		size_t total_prime = 0;
		MPI_Reduce(&prime_count, &total_prime, 1, MPI_UNSIGNED_LONG_LONG, MPI_SUM, 0, MPI_COMM_WORLD);
